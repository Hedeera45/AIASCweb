    ...
    <>
      ...
      <section className="section-block">
        ...
        <div className="text-block">
          ...
          &nbsp;&nbsp;<em style={{ fontSize: "0.8em" }}>y por información consultable en esta página, "cómo tramito..."</em>&nbsp;&nbsp;<a href="https://www.caja8470.com.ar/preguntas-frecuentes/" target="_blank" rel="noopener noreferrer">&gt;</a>&nbsp;&nbsp;<br />
          - Pueden jubilarse aquellos que tengan 30 años de aporte y más de 65 años.<br />
          - El Haber Promedio Básico es a MAYO 2026: $646.800&nbsp;&nbsp;<a href="https://www.caja8470.com.ar/nuevo-aumento-haber-jubilatorio-mayo-2026/" target="_blank" rel="noopener noreferrer">&gt;</a><br />
        ...
        <div className="text-block">
          ...
          - El aporte mínimo anual básico&nbsp;&nbsp;<a href="https://www.caja8470.com.ar/pagos-aportes-minimos/" target="_blank" rel="noopener noreferrer">&gt;</a>&nbsp;&nbsp;, cambia de valor dependiendo de la edad del aportante, y si está en relación de dependencia o no (en cuyo caso se calcula, del normal, el 33%).<br />
